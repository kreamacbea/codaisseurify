...
artist4 = Artist.create!({ name: "Royksopp", remote_image_url: "https://res.cloudinary.com/db926f0zb/image/upload/v1505059758/ODESZA-CORNERSOFTHEEARTH_ptyoo0.jpg" })
...
song1 = Song.create!(title: "Corners Of The Earth (feat. RY X)", length: "5:05", artist: artist3)
